...
const form = useForm({
    minimum_distance: props.rewardConfiguration.minimum_distance,
    reward_name: props.rewardConfiguration.reward_name,
    discount_percentage: Number(props.rewardConfiguration.discount_percentage),
    status: props.rewardConfiguration.status,
});

function submit() {
    form.put(
        route("reward-configurations.update", props.rewardConfiguration.id),
    );
}
</script>
