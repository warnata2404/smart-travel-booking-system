...
class StoreRewardConfigurationRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'minimum_distance' => [
                ...
                'integer',
                'min:1',
                'unique:reward_configurations,minimum_distance',
            ],
            ...
            'reward_name' => [
                ...
                'string',
                'max:100',
                'unique:reward_configurations,reward_name',
            ],
            ...
            'status' => [
                'required',
                Rule::enum(RewardConfigurationStatus::class),
            ],
        ];
    }
